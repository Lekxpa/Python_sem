...
# with open('Numb4.txt', 'r', encoding='utf-8') as full:
#     my_str = full.read()
# with open('Numb5.txt', 'w', encoding='utf-8') as hash:
#     hash.write(ToHash(my_str))

# with open('Numb5.txt', 'r', encoding='utf-8') as hash:
#     my_str = hash.read()
# with open('Numb4.txt', 'w', encoding='utf-8') as full:
